...
import migration0043 from '../../../src-tauri/migrations/0043_petrolpump.sql?raw'; // [petrolpump] [all tenants]
import migration0044 from '../../../src-tauri/migrations/0044_furniture.sql?raw'; // [furniture] [all tenants]
import migration0045 from '../../../src-tauri/migrations/0045_printing.sql?raw'; // [printing] [all tenants]
...
export async function readMigrations(): Promise<Migration[]> {
  return [
    ...
    { name: '0043_petrolpump', sql: migration0043 }, // [petrolpump] [all tenants]
    { name: '0044_furniture', sql: migration0044 },  // [furniture] [all tenants]
    { name: '0045_printing', sql: migration0045 },   // [printing] [all tenants]
  ];
}
